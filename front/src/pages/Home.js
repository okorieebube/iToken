        ...
        <div>
            ...
            <div className="main-hero mb-5 mb-md-0">
                <div className="hero-main-inr">
                            ...
                            <div className="nav-inr">
                                <div className="burger-menu">
                                    <a href="#top" className="logo-otr" data-scroll>
                                        <img className="logo-img align-middle" src="assets/opensea.svg" alt="brand-logo" style={{ width: 40 }} />
                                        <svg className="mx-1 pt-1" fill="#04111D" height={40} style={{ width: 100 }} viewBox="0 0 313 58" width={313}>
                                ...
                                <div className="navigation-otr d-none d-sm-block">
                                    <ul className="navigation-inr d-flex">
                                        <li className="nav-li me-5">
                                            <a href="#token" data-scroll className="nav-a body-sb" style={{ color: '#666' }}>Token</a>
                                        </li>
                                        <li className="nav-li me-5">
                                            <a href="#roadmap" data-scroll className="nav-a body-sb" style={{ color: '#666' }}>Introduce</a>
                                        </li>
                                        <li className="nav-li me-5">
                                            <a href="https://t.me/OStoken" target="_blank" className="nav-a body-sb" style={{ color: '#666' }}>Telegram<i className="icofont-external-link ms-1" /></a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="language-selector">
                                    <ul className="language-ul d-flex">
                                        <li className="language-li position-relative">
                                            <a className="language-a d-flex align-center px-3 py-1 align-items-center" data-bs-toggle="collapse" href="#lang-collapse" style={{ border: '1px solid #CFCFCF', borderRadius: 16, color: '#666' }}>
                                                🇬🇧 <p className="body-sb language px-2">English</p>
                                                <svg className="caret-down" width={12} height={8} fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11 1.5l-5 5-5-5" stroke="#666" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </a>
                                            <ul id="lang-collapse" className="drop-ul collapse position-absolute bg-white px-3 py-2 mt-2 shadow w-100" style={{ borderRadius: 16, zIndex: 100 }}>
                                                <li className="drop-li">
                                                    <a href="javascript:;" className="drop-a d-inline-flex align-items-center lang" data-lang="en" style={{ color: '#666' }}>
                                                        🇬🇧 <p className="body-sb language mx-2">English</p>
                                                    </a>
                                                </li>
                                                <li className="drop-li">
                                                    <a href="javascript:;" className="drop-a d-inline-flex align-items-center lang" data-lang="zh" style={{ color: '#666' }}>
                                    ...
                                    <div className="col-12 col-content-otr" style={{ width: '100% !important' }}>
                                        <div className="col-content-inr">
                                            ...
                                            <div className="action-otr justify-content-center">
                                                <a href="#airdrop" data-scroll className="btn-outline2 btn-wallet order-lg-2 my-2 mx-2 mx-lg-3">Airdrop</a>
                                                <a href="#presale" data-scroll className="btn-fill btn-create order-lg-1 my-2 mx-2 mx-lg-3">Pre-sale</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <img className="shape" src="assets/img/svg/home2-shape.svg" alt="shape" />
                </div>
            </div>
            <div id="token" className="call-to-action-home2 justify-content-center my-5">
                <div className="container-fluid">
                    <div className="call-to-action p-4 p-md-5 mb-3 text-shadow">
                        <div className="wrapper row">
                            <div className="col-lg-7 col-xl-6">
                                <h2 className="heading-h2 heading">OpenSea (OS) Token</h2>
                                <p className="text-muted body-m mb-2">OpenSea is the world’s first &amp; largest NFT (Non-Fungible
                                    Token) marketplace on the Ethereum network. Now, OpenSea has issued ERC20 token OS based on
                                    the Ethereum chain, with a total supply of 20 million, and open-source smart contract code
                                    have been publicized.</p>
                                <p className="text-muted body-m mb-2">25% OS tokens for trading airdrop, distributed to active users
                                    of the OpenSea. 15% OS tokens for community airdrop, distributed to community users for
                                    free. For specific airdrop details, please visit the OpenSea Foundation website
                                    (https://opensea.foundation). 25% OS tokens for pre-sale, and the pre-sale price is 1 ETH =
                                    10,000 OS. After the pre-sale ends, OS will be listed on exchanges such as Binance, Huobi
                                    and Coinbase.</p>
                                ...
                                <ul>
                                    ...
                                    <li className="my-1 d-flex align-items-center">
                                        ...
                                        <span className="text-muted mx-2 text-nowrap">Contract Address</span>
                                        <span className="text-primary text-break copy">0x671167fFA438C87F134395d68b820d5a42202214</span>
                                        <a href="https://etherscan.io/token/0x671167fFA438C87F134395d68b820d5a42202214" target="_blank" className="ms-2"><i className="icofont-external-link text-primary" /></a>
                                    </li>
                                    <li className="my-1 d-flex align-items-center">
                                    ...
                                    <li className="my-1 d-flex align-items-center">
                                        ...
                                        <span className="text-muted mx-2">Total Supply</span>
                                        <span className="text-primary">20,000,000</span>
                                    </li>
                                    <li className="my-1 d-flex align-items-center">
                        ...
                        <div className="img-otr">
                            <div className="img-inr">
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/4.png" alt="img" />
                                </div>
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/5.png" alt="img" />
                                </div>
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/6.png" alt="img" />
                                </div>
                            </div>
                            <div className="img-inr">
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/7.png" alt="img" />
                                </div>
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/8.png" alt="img" />
                                </div>
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/9.png" alt="img" />
                                </div>
                            </div>
                            <div className="img-inr d-none d-xl-block">
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/1.png" alt="img" />
                                </div>
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/3.png" alt="img" />
                                </div>
                                <div className="col-img-inr">
                                    <img className="about-img img-fluid" src="assets/img/2.png" alt="img" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="presale" className="live-acution-home2 justify-content-center" style={{ padding: '30px 0 50px 0 !important' }}>
                <div className="container-fluid max-width-1000">
                    <div className="live-auction-inr">
                        <div className="heading-otr">
                            <div className="head-otr">
                                <span className="dot" />
                                <h3 className="heading heading-h3">Pre-sale is Live</h3>
                            </div>
                        </div>
                        <span className="line" />
                        <div>
                            <p className="mb-2">
                                Pre-sale supply: 5,000,000
                            </p>
                            <p className="mb-2">Pre-sale address: <span className="text-primary copy text-break">0x9143d439c64FeEa073100b8E8Ff62c5A729BaDeb</span> <a className="copy d-inline-block" text="0x9143d439c64FeEa073100b8E8Ff62c5A729BaDeb" href="javascript:;"><i className="icofont-ui-copy" /></a></p>
                            <p className="mb-2">Pre-sale price: 1 ETH = 10,000 OS</p>
                            <p className="mb-2">
                                Use your wallet to send ETH to the Pre-sale address. Our system will send OS tokens to your
                                wallet instantly.
                            </p>
                            <p className="mb-2">
            ...
            <div id="airdrop" className="work-main-home2 justify-content-center" style={{ backgroundImage: 'url(assets/img/svg/footer-circles2.svg)', backgroundRepeat: 'no-repeat', backgroundPosition: 'top left' }}>
                <div className="container-fluid max-width-1000">
                    <div className="wrapper">
                        <h3 className="head heading-h3">Airdrop</h3>
                    </div>
                    <div id="airdrop-block" className="row row-work justify-content-center">
                        <div className="col-12 col-sm-10 col-md-9 col-lg-8">
                            <form id="airdrop-form" data-lpignore="true">
                                ...
                                <div className="input-group">
                                    <input name="address" className="input form-control" type="text" placeholder="Input your ETH address" />
                                    <button type="submit" className="btn btn-fill py-2">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div id="roadmap" className="work-main-home2 justify-content-center" style={{ backgroundImage: 'url(assets/img/svg/footer-circles1.svg)', backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom right' }}>
                <div className="container-fluid max-width-1000">
                    <div className="wrapper">
                    ...
                    <div className="row-work justify-content-center">
                        <div className="shadow py-3 px-4 mb-4" style={{ borderRadius: 24 }}>
                            ...
                            <ul className="text-muted">
                                ...
                                <li>
                                    <span className="text-primary me-2">●</span>
                                    Whitelist: OpenSea will take a snapshot of data based on the two dimensions of address
                                    transaction activity and transaction volume at 20:30 (UTC+8) on September 27, 2021. OS
                                    tokens will be allocated to OpenSea’s historical users according to the snapshot. So if you
                                    have traded in OpenSea before, you are on the list to be rewarded.
                                </li>
                                <li>
                                    <span className="text-primary me-2">●</span>
                                    Time and quantity: OS tokens will be distributed to the whitelisted addresses at 20:30
                                    (UTC+8) on October 13, 2021. Whitelisted addresses can claim airdrop reward on the official
                                    website (opensea.io). The reward for a single address is 10-50 OS tokens.
                                </li>
                            </ul>
                        </div>
                        <div className="shadow py-3 px-4 mb-4" style={{ borderRadius: 24 }}>
                            ...
                            <ul className="text-muted">
                                ...
                                <li>
                                    <span className="text-primary me-2">●</span>
                                    Airdrop rules: OpenSea will start community airdrop activities at 20:30 (UTC+8) on September
                                    27, 2021, and the airdrop time is 15 days. Community users can participate in the airdrop by
                                    submitting the ETH wallet address on the OpenSea Foundation website (opensea.foundation).
                                    The initial amount of each address is 10 OS. The airdrop is completely free, and the airdrop
                                    rewards will be distributed to the submitted address after the airdrop is over. Airdrop
                                    participation addresses are estimated to be 200,000. If the total airdrop award exceeds the
                                    quantity for airdrop, the airdrop event will end early. If there are still unclaimed OS
                                    tokens after the airdrop ends, the unclaimed part will be permanently destroyed.
                                </li>
                                <li>
                                    <span className="text-primary me-2">●</span>
                                    Invitation rules: Users can get additional token rewards by inviting friends to participate
                                    in the airdrop. You can get 10 OS tokens for each friend you invite. You can invite up to 50
                                    friends, and get up to 500 OS tokens. The quantity for airdrop is limited, and OS issuance
                                    is small. The estimated price of OS is $50. Hurry up and share it with your friends.
                                </li>
                            </ul>
                        </div>
                        <div className="shadow py-3 px-4 mb-4" style={{ borderRadius: 24 }}>
                            ...
                            <ul className="text-muted">
                                ...
                                <li>
                                    <span className="text-primary me-2">●</span>
                                    Pre-sale price: 1 ETH = 10,000 OS. The minimum purchase is 0.1 ETH, and the maximum purchase
                                    is 10 ETH (the pre-sale quantity is limited, and the excess ETH will be automatically
                                    returned).
                                </li>
                                <li>
                                    <span className="text-primary me-2">●</span>
                                    Pre-sale rules: The system will start the pre-sale at 20:30 (UTC+8) on September 27, 2021,
                                    and the pre-sale time is 15 days. Use your wallet to send ETH to the pre-sale address, and
                                    the system will immediately send the corresponding amount of OS tokens to your wallet. The
                                    quantity of OS tokens for pre-sale is limited, and the quota is sorted according to the
                                    arrival time of ETH, first come first served.
                                </li>
                            </ul>
                        </div>
                        <div className="shadow py-3 px-4 mb-4" style={{ borderRadius: 24 }}>
                            <div className="heading-h4">OpenSea(OS) Tokenomics</div>
                            <ul className="text-muted">
                                <li>
                                    <span className="text-primary me-2">●</span>
            ...
            <div className="footer-home2 pt-4 pb-0">
                <div className="container-fluid">
                    <div className="wrapper pb-4 justify-content-start">
                        <h4 className="heading-h4 ethoz-head me-md-4">
                            Get Latest Updated from OpenSea Foundation
                        </h4>
                        <ul className="icon-ul">
                            <li className="icon-li">
                                <a href="https://t.me/OStoken" target="_blank" className="icon-a">
                                    <svg className="icon" width={32} height={32} fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11 16.859l11.24 9.89a1 1 0 001.635-.527l4.702-20.516a1 1 0 00-1.34-1.154l-23.07 9.063a1 1 0 00.17 1.911L11 16.86zM11 16.86L28.014 4.57" stroke="#999" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M16.613 21.799l-3.906 3.906A1 1 0 0111 24.998v-8.14" stroke="#999" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </a>
                            </li>
                        </ul>
                ...
                <img className="shape1" src="assets/img/Squares-shape2-home2.svg" alt="Squares" />
                <img className="shape2" src="assets/img/Squares-shape1-home2.svg" alt="Squares" />
            </div>
            <div className="copy-otr-home2">
                <div className="container-fluid">
                    <div className="copy-inr">
                        <a href="#top" className="logo-otr">
                            <img className="logo" src="assets/opensea.svg" alt="brand-logo" style={{ height: 30, width: 30 }} />
                        </a>
                        <div className="copy-name body-s">
                            Copyright © 2021 by opensea.foundation
                        </div>
                        <div className="all-rights">
                            <p className="all body-s">
                                All rights reserved.
                            </p>
                        </div>
                    </div>
