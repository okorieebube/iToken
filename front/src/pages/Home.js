                    ...
                    <div className="col-content-inr">
                      <div className="head-otr">
                        <h1 className="heading-h1 heading titleGreathorned text-center mt-lg-5">
                          iToken (ITK) <span>Token Airdrop</span>
                        </h1>
                      </div>
          ...
          <div className="call-to-action p-4 p-md-5 mb-3 text-shadow">
            <div className="wrapper row">
              <div className="col-lg-7 col-xl-6">
                <h2 className="heading-h2 heading">iToken (ITK) Token</h2>
                <p className="text-muted body-m mb-2">
                  iToken is the world’s first &amp; largest NFT (Non-Fungible
                  Token) marketplace on the Ethereum network. Now, iToken has
                  issued ERC20 token OS based on the Ethereum chain, with a
                  total supply of 20 million, and open-source smart contract
                  code have been publicized.
                </p>
                <p className="text-muted body-m mb-2">
                ...
                <ul>
                  ...
                  <li className="my-1 d-flex align-items-center">
                    ...
                    <span className="text-primary text-break copy">
                      0x671167fFA438C87F134395d68b820d5a42202214
                    </span>
                    <a
        ...
        <div className="container-fluid max-width-1000">
          <div className="live-auction-inr">
            ...
            <div>
              ...
              <p className="mb-2">
                Use your wallet to send ETH to the Pre-sale address. Our system
                will send OS tokens to your wallet instantly.
              </p>
              <p className="mb-2">
